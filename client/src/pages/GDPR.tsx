    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-16">
        <div className="container max-w-3xl">
          <h1 className="text-4xl font-serif mb-2">{locale === "en" ? "Privacy Policy" : "Ochrana osobných údajov"}</h1>
          <p className="text-sm text-muted-foreground font-sans mb-4">{locale === "en" ? "In accordance with Regulation (EU) 2016/679 (GDPR)" : "V súlade s nariadením (EÚ) 2016/679 (GDPR)"}</p>

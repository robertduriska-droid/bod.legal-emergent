    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-16">
        <div className="container max-w-3xl">
          <h1 className="text-4xl font-serif mb-2">{locale === "en" ? "Cookie Policy" : locale === "cz" ? "Zásady používání cookies" : "Zásady používania cookies"}</h1>
          ...
          <div className="prose prose-sm font-sans max-w-none text-muted-foreground space-y-6">
            ...
            <section>
              ...
              <p>V prípade otázok týkajúcich sa cookies nás kontaktujte na <a href="mailto:info@bod.legal" className="text-primary hover:underline">info@bod.legal</a>.</p>
            </section>
          </div>
        </div>
      </main>

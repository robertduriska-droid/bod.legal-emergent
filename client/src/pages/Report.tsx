...
const TX = {
  sk: {
    ...
    freePreviewDesc: "Vidíte iba 3 najzávažnejšie riziká. Plný report obsahuje analýzu všetkých klauzúl, právne základy, navrhované úpravy a overenie advokátskou kanceláriou alebo advokátom.",
    orderFull: "Objednať plný report od 249 eur",
    legalSources: "Použité právne zdroje",
    disclaimer1: "Tento report bol vygenerovaný systémom bod.legal s využitím AI a overený advokátskou kanceláriou alebo advokátom.",
    ...
    surveyYes: "Áno",
    surveyNo: "Nie",
    disclaimer1Unsigned: "Tento report vygenerovala AI systému bod.legal a čaká na overenie advokátskou kanceláriou alebo advokátom.",
    reviewBanner: "Advokátska kancelária alebo advokát ešte overuje report. Nálezy sa môžu doplniť alebo zmeniť.",
  ...
  en: {
    ...
    disclaimer1: "This report was generated by the bod.legal system using AI and verified by a law firm or lawyer.",
    ...
    surveyYes: "Yes",
    surveyNo: "No",
    disclaimer1Unsigned: "This report was generated by the bod.legal AI system and is awaiting verification by a law firm or lawyer.",
  ...
  cz: {
    ...
    freePreviewDesc: "Vidíte pouze 3 nejzávažnější rizika. Plný report obsahuje analýzu všech klauzulí, právní základy, navrhované úpravy a ověření advokátní kanceláří nebo advokátem.",
    orderFull: "Objednat plný report od 7 490 Kč",
    legalSources: "Použité právní zdroje",
    disclaimer1: "Tento report byl vygenerován systémem bod.legal s využitím AI a ověřen advokátní kanceláří nebo advokátem.",
    ...
    surveyYes: "Ano",
    surveyNo: "Ne",
    disclaimer1Unsigned: "Tento report vygenerovala AI systému bod.legal a čeká na ověření advokátní kanceláří nebo advokátem.",

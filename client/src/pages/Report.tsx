...
import { ArrowLeft, Loader2, CheckCircle, Download, ExternalLink, Shield, FileDown, FileText, Check, X, RotateCcw, Columns2, EyeOff, MessageCircle, Send, Trash2 } from "lucide-react";
...
const TX = {
  sk: {
    ...
    commentPlaceholder: "Napíšte komentár pre advokáta...",
    sendComment: "Odoslať",
    comments: "Komentáre",
  ...
  en: {
    ...
    commentPlaceholder: "Write a comment for the lawyer...",
    sendComment: "Send",
    comments: "Comments",
  ...
  cz: {
    ...
    orderFull: "Objednat plný report od 6 300 Kč",
    ...
    commentPlaceholder: "Napište komentář pro advokáta...",
    sendComment: "Odeslat",
    comments: "Komentáře",
                        ...
                        {!isLimited && (() => {
                          ...
                          return (
                            <div className="mt-3 pt-2 border-t border-muted-foreground/10">
                              <button
                                onClick={() => toggleComments(clause.id)}
                              ...
                              >
                                ...
                                {tx.comments} {clauseComments.length > 0 && `(${clauseComments.length})`}
                              </button>
                              {isExpanded && (
                                <div className="mt-2 space-y-2">
                                  ...
                                  <Button
                                    ...
                                    className="h-7 px-3 text-[11px] font-sans gap-1 mt-1"
                                  >
                                    <Send className="h-3 w-3" /> {tx.sendComment}
                                  </Button>
                                </div>
                              )}
                            </div>

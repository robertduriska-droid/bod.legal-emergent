...
const LABELS = {
  sk: {
    ...
    company: "Prevádzkované KILIAN LEGAL s.r.o. | IČO: 53 957 008 | robert.duriska@kilian.sk",
  ...
  en: {
    ...
    company: "Operated by KILIAN LEGAL s.r.o. | ID: 53 957 008 | robert.duriska@kilian.sk",
